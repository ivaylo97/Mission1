...
import hotelserviceapp.Support.BookingExceptions.BookingAlreadyExistsException;
import hotelserviceapp.Support.BookingExceptions.BookingFailureException;
import hotelserviceapp.Support.DateExceptions.NullDateExceptionBookingFailureException;
import hotelserviceapp.Support.DateExceptions.OverlappingEndDateException;
import hotelserviceapp.Support.DateExceptions.OverlappingStartingDateException;
...
public class Room {
	//static private int TOTAL_NUMBER_OF_ROOMS = 0; //keeping it , for now .
	...
	public Room() {
		...
		//usually the room number is set in the addNewRoom method in hotel
		// where it is set with the index of the room's place in the list of rooms
	}
	...
	public void maintainRoom(LocalDate newMaintenanceDate) {
		...
		if (newMaintenanceDate == null) {
			throw new NullDateExceptionBookingFailureException();
		}
	...
	/**
	 * Adds as much showers to the room as, are specified in the numberOfShowersToAdd variable.
	 */
